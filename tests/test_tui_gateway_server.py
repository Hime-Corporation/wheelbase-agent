...
def test_ensure_session_db_row_persists_explicit_cwd(monkeypatch, tmp_path):
    ...
    class _FakeDB:
        def create_session(self, key, source=None, model=None, model_config=None, cwd=None, user_id=None):
            created.append(
...
def test_session_most_recent_returns_first_non_denied(monkeypatch):
    ...
    class _DB:
        def list_sessions_rich(self, *, source=None, limit=200, user_id=None):
            return [
