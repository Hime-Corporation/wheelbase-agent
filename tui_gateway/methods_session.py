...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        # from config (sessions.max_resume_messages, 0 disables). Runs AFTER the
        # ownership gate/tip resolution above — the safety check bounds size, it
        # must never be what decides access.
