...
try:
    ...
    # aiohttp 3.12 still provides ``web`` but removed the old RequestKey
    # export. The request metadata helpers below already support a string-key
    # fallback, so keep HTTP handlers usable on both versions.
